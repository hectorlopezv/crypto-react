...
import { useGetUserCoinBseTransactions } from "../apis/hooks/users-queries";

const TransactionsGrid: React.FC = () => {
  const { data, isLoading } = useGetUserCoinBseTransactions();
          ...
          <TableBody>
            {data?.data?.data?.map((transaction: any) => (
              ...
              >
                ...
                <TableCell align="right">{transaction.amount.amount}</TableCell>
